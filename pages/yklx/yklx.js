...
Page({
  ...
  endTestFn() {
    ...
    let obj = {
      ...
      "searchValue": "",
      "subType": this.data.category,
      "xm": this.data.xm,
      "zjh": this.data.zjh,
      "userId": 0
    }
    app.$api.post('/qb/sub/practice/addRecordUnauth', obj, 'application/json; charset=UTF-8')
    this.setData({
      testType: 'end',
      TestEndMsg
    })
  ...
  async getTestTm() {
    ...
    await app.$api.post('/qb/sub/practice/realhListUnauth', {
      openId: app.globalData.openId,
      subType: this.data.category,
      xm: this.data.xm,
      zjh: this.data.zjh
